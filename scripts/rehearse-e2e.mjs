// Continue an already code-reviewed fixture; never create a replacement issue/task.
...
if (!priorPath || !evidencePath || existsSync(evidencePath))
  throw Error(
    "Usage: rehearse-e2e CODE_REVIEW_EVIDENCE NEW_EVIDENCE; reconcile existing output",
  );
...
try {
  ...
  assert.equal(initial.stage, "e2e-review");
